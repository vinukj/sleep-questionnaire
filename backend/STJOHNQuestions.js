export const STJohnQuestionnaire = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "waketime", type: "time", label: "Wake Time" },
      {
        id: "sleep_latency",
        type: "radio",
        label: "Sleep latency",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "snoring", type: "radio", label: "Snoring", options: ["Y", "N"] },
      {
        id: "witnessed_apneas",
        type: "radio",
